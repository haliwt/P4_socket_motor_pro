...
void MX_USART1_UART_Init(void)
{
  ...
  */
  ...
  LL_DMA_SetMode(DMA1, LL_DMA_CHANNEL_4, LL_DMA_MODE_NORMAL);//WT.EDIT //LL_DMA_MODE_NORMAL);//
  ...
  USART_InitStruct.DataWidth = LL_USART_DATAWIDTH_9B;//WT.EDIT 2025.12.09//8B;
  USART_InitStruct.StopBits = LL_USART_STOPBITS_1;
  USART_InitStruct.Parity = LL_USART_PARITY_EVEN;//NONE;
